import { BadGatewayException, BadRequestException, ConflictException, InternalServerErrorException } from "@nestjs/common";
...
describe('UserRepository', () => {
  ...
  describe('validateUserPassword', () => {
    ...
    it('returns null as pawword is invalid', async () => {
      userRepository.findOne.mockResolvedValue(user);
